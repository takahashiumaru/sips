                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                @elseif ($t->status === 'lunas')
                                    ...
                                    @endphp
                                    @if ($pembayaranLunas)
                                        <a href="{{ route('kwitansi.download', $pembayaranLunas) }}" class="inline-flex items-center gap-1.5 px-2.5 py-1.5 bg-blue-50/30 border border-blue-100/60 text-blue-500 hover:text-white hover:bg-brand-light rounded-xl transition-all btn-premium">

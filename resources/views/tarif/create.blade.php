...
@section('page_title', 'Tambah Tarif SPP')
@section('page_subtitle', 'Masukkan besaran biaya pembayaran SPP bulanan')
...
<div class="form-page-card bg-white rounded-2xl border border-blue-100/50 p-6 shadow-sm card-premium">
    <div class="flex items-center justify-between border-b border-blue-50 pb-4 mb-6">
        <h2 class="text-xs font-bold text-slate-800 uppercase tracking-wider">Form Tarif Baru</h2>
    </div>
    ...
    <form action="{{ route('tarif.store') }}" method="POST" class="space-y-5">
        @csrf
        ...
        <div class="form-grid-wide">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="jumlah" id="jumlah" value="{{ old('jumlah') }}" required min="0" step="1"
